...
if ($success === true)
{
	...
	$ds= $_SESSION['ds'];
    $charges = "500";
	$sql = "INSERT INTO `premium`( `name`, `age`, `phn`, `hus`, `email`, `ads`, `mnth`, `ds`, `charges`, `razorpay_payment_id`, `status`) VALUES 
	('$name','$age','$phn','$hus','$email','$ads','$mnth','$ds','$charges','$razorpay_payment_id','success')";
	/*"INSERT INTO `vbooking`(`name`, `age`, `gender`, `parentname`, `phone`, `email`, `address`, `date`, `uploads`, `charges`, `razorpay_payment_id`, `status`)
